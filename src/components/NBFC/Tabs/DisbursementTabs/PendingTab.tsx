...
const PendingTab = () => {
  ...
  return (
    <>
      <Table tname="Pending Table" theading={["Loan Disbursement Date", "Loan ID", "Name of the Borrower", "Loan Amount", "View Loan Application", "Compliance Check"]} tData={tableData} />
      {
